...
def main():
    ...
    for i, batch in tqdm(enumerate(dataloader), total=len(dataloader)):
        ...
        Final_input = [{'question': question, 'option': option } for question, option in zip(batch['query'], batch['possible_answers'])]
        # execute Final prediction then return final_answer
        final_answers = interpreter.step_interpreters['llama'].generate(Final_input, prompt_type='llm_only')
