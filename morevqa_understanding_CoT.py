...
def main():
    ...
    for i, batch in enumerate(metric_logger.log_every(dataloader, 1, header)):
        ...
        S1_programs = Program_generation_CoT(config, device=device, data=S1_input, prompt_type='stage1_CoT')
        ...
        S2_programs = Program_generation_CoT(config, device=device, data=S2_input, prompt_type='stage2_CoT')
        ...
        S3_programs = Program_generation_CoT(config, device=device, data=S3_input, prompt_type='stage3_CoT')
        ...
        S4_programs = Program_generation_CoT(config, device=device, data=S4_input, prompt_type='stage4_CoT')
