...
from engine import Program_generation, Module1, Module2_retrieve, Module3
import util
...
def main():
    ...
    for i, batch in enumerate(metric_logger.log_every(dataloader, 1, header)):
        ...
        M2_programs = Program_generation(config, device=device, data=M2_input, prompt_type='module2_retrieve')
        ...
        EXTERNAL_MEMORY = Module2_retrieve(config, EXTERNAL_MEMORY, data=M2_input, stage='module2', device=device)
